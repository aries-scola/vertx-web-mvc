...
public interface ActionResult {
	...
	public static ContentResult content(byte[] content) {
		return new ContentResultImpl(content);
	}
	...
	public static ContentResult content(String content, Charset charset) {
		return new ContentResultImpl(content, charset);
	}

	public static FileResult file(File file) {
		return new FileResultImpl(file);
	}

	public static ForwardResult forward(String actionName) {
